<div class="font-sans">
    ...
    <div class="space-y-5 text-center" wire:key="step-3">
        ...
        <div class="space-y-2.5 pt-1">
            <a href="https://wa.me/256777643084?text=Hi%2C+I+submitted+a+reservation+request+with+reference+{{ $reference }}"
                target="_blank"
            ...
            <p class="font-sans text-xs text-[#f5f2ea]/35">Or call: +256 777 643084 · +256 761 311 772</p>
        </div>
    </div>
    @endif
